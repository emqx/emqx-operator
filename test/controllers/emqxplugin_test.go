...
// var _ = Describe("Check external plugin", func() {
// 	pluginList := []string{"emqx_management", "emqx_dashboard", "emqx_rule_engine", "emqx_retainer", "emqx_lwm2m"}
// 	ports := []corev1.ServicePort{
// 		{
// 			Name:       "lwm2m-bind-udp-1",
...
// 	Context("Check external plugins", func() {
// 		JustBeforeEach(func() {
...
// 		It("should create a configMap with plugins config", func() {
// 			check_plugins_config(broker, pluginList)
// 			check_plugins_config(enterprise, append(pluginList, "emqx_modules"))
// 		})

// 		It("should create a configMap with loaded plugins", func() {
// 			check_loaded_plugins(broker, "emqx_management.\nemqx_dashboard.\nemqx_retainer.\nemqx_rule_engine.\nemqx_lwm2m.\n")
// 			check_loaded_plugins(enterprise, "emqx_management.\nemqx_dashboard.\nemqx_retainer.\nemqx_rule_engine.\nemqx_modules.\nemqx_lwm2m.\n")
// 		})

// 		It("should add plugin ports for service", func() {
// 			check_service_ports(types.NamespacedName{Name: "emqx", Namespace: broker.Namespace}, ports)
// 			check_service_ports(types.NamespacedName{Name: "emqx-ee", Namespace: enterprise.Namespace}, ports)
// 		})
// 	})

// 	Context("Check Update plugin", func() {
...
// 	Context("Check Delete plugin", func() {
// 		var ports []corev1.ServicePort
// 		JustBeforeEach(func() {
// 			ports = []corev1.ServicePort{
// 				{
...
// 		It("should delete plugin config", func() {
// 			for _, emqx := range []v1beta3.Emqx{broker, enterprise} {
// 				Eventually(func() string {
// 					cm := &corev1.ConfigMap{}
// 					_ = k8sClient.Get(
...
// 		It("should delete plugin ports for service", func() {
// 			for _, emqx := range []v1beta3.Emqx{broker, enterprise} {
// 				Eventually(func() []corev1.ServicePort {
// 					svc := &corev1.Service{}
// 					_ = k8sClient.Get(
