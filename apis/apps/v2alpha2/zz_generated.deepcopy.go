...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EMQXNodeStatus) DeepCopyInto(out *EMQXNodeStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EMQXNodeStatus.
func (in *EMQXNodeStatus) DeepCopy() *EMQXNodeStatus {
	if in == nil {
		return nil
	}
	out := new(EMQXNodeStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EMQXStatus) DeepCopyInto(out *EMQXStatus) {
	*out = *in
	...
	in.CoreNodeStatus.DeepCopyInto(&out.CoreNodeStatus)
	in.ReplicantNodeStatus.DeepCopyInto(&out.ReplicantNodeStatus)
}
