...
//+kubebuilder:webhook:path=/mutate-apps-emqx-io-v1beta4-emqxplugin,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.emqx.io,resources=emqxplugins,verbs=create;update,versions=v1beta3,name=mutating.emqxplugin.emqx.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-apps-emqx-io-v1beta4-emqxplugin,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.emqx.io,resources=emqxplugins,verbs=create;update,versions=v1beta3,name=validator.emqxplugin.emqx.io,admissionReviewVersions={v1,v1beta1}
