...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EmqxRebalance) DeepCopyInto(out *EmqxRebalance) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EmqxRebalance.
func (in *EmqxRebalance) DeepCopy() *EmqxRebalance {
	if in == nil {
		return nil
	}
	out := new(EmqxRebalance)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *EmqxRebalance) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EmqxRebalanceList) DeepCopyInto(out *EmqxRebalanceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]EmqxRebalance, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EmqxRebalanceList.
func (in *EmqxRebalanceList) DeepCopy() *EmqxRebalanceList {
	if in == nil {
		return nil
	}
	out := new(EmqxRebalanceList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *EmqxRebalanceList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EmqxRebalanceSpec) DeepCopyInto(out *EmqxRebalanceSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EmqxRebalanceSpec.
func (in *EmqxRebalanceSpec) DeepCopy() *EmqxRebalanceSpec {
	if in == nil {
		return nil
	}
	out := new(EmqxRebalanceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EmqxRebalanceStatus) DeepCopyInto(out *EmqxRebalanceStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]Condition, len(*in))
	...
	if in.Rebalances != nil {
		in, out := &in.Rebalances, &out.Rebalances
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EmqxRebalanceStatus.
func (in *EmqxRebalanceStatus) DeepCopy() *EmqxRebalanceStatus {
	if in == nil {
		return nil
	}
	out := new(EmqxRebalanceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RebalanceStrategy) DeepCopyInto(out *RebalanceStrategy) {
	*out = *in
	if in.ConnEvictRate != nil {
		in, out := &in.ConnEvictRate, &out.ConnEvictRate
		*out = new(int32)
		**out = **in
	}
	if in.SessEvictRate != nil {
		in, out := &in.SessEvictRate, &out.SessEvictRate
		*out = new(int32)
		**out = **in
	}
	if in.WaitTakeover != nil {
		in, out := &in.WaitTakeover, &out.WaitTakeover
		*out = new(int32)
		**out = **in
	}
	if in.WaitHealthCheck != nil {
		in, out := &in.WaitHealthCheck, &out.WaitHealthCheck
		*out = new(int32)
		**out = **in
	}
	if in.AbsConnThreshold != nil {
		in, out := &in.AbsConnThreshold, &out.AbsConnThreshold
		*out = new(int32)
		**out = **in
	}
	if in.RelConnThreshold != nil {
		in, out := &in.RelConnThreshold, &out.RelConnThreshold
		*out = new(string)
		**out = **in
	}
	if in.AbsSessThreshold != nil {
		in, out := &in.AbsSessThreshold, &out.AbsSessThreshold
		*out = new(int32)
		**out = **in
	}
	if in.RelSessThreshold != nil {
		in, out := &in.RelSessThreshold, &out.RelSessThreshold
		*out = new(string)
		**out = **in
	}
}
