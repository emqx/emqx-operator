...
func (in *BootsrapAPIKey) DeepCopyInto(out *BootsrapAPIKey) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootsrapAPIKey.
func (in *BootsrapAPIKey) DeepCopy() *BootsrapAPIKey {
	if in == nil {
		return nil
	}
	out := new(BootsrapAPIKey)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EmqxContainer) DeepCopyInto(out *EmqxContainer) {
	*out = *in
	...
	if in.BootstrapAPIKeys != nil {
		...
		*out = make([]BootsrapAPIKey, len(*in))
		copy(*out, *in)
	}
}
