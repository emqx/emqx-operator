...
func (a addListener) reconcile(ctx context.Context, instance v1beta4.Emqx, _ ...any) subResult {
	if !v1beta4.IsClusterReady(instance.GetStatus()) {
		return subResult{result: ctrl.Result{RequeueAfter: time.Second}}
	}
	resources := []client.Object{}
	svc := a.generateListenerService(ctx, instance, a.portForwardAPI)
	if svc == nil {
		return subResult{}
	}
...
func (a addListener) generateListenerService(ctx context.Context, instance v1beta4.Emqx, p *portForwardAPI) *corev1.Service {
	...
	return &corev1.Service{
		...
		Spec: instance.GetSpec().GetServiceTemplate().Spec,
	}
}
