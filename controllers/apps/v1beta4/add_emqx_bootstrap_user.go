...
func (a addEmqxBootstrapUser) reconcile(ctx context.Context, logger logr.Logger, instance appsv1beta4.Emqx, _ ...any) subResult {
	...
	if err := a.Client.Get(ctx, client.ObjectKeyFromObject(bootstrapUser), bootstrapUser); err != nil {
		if k8sErrors.IsNotFound(err) {
			...
			if err := a.Handler.Create(ctx, bootstrapUser); err != nil {
